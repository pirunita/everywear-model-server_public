...
if __name__ == '__main__':
    ...
    """
    load_checkpoint(men_tshirts_GMM, 'model/' + CATEGORY_DICT['1001'] + '/GMM/gmm_final.pth')
    MODEL_DICT = {'1001' : (men_tshirts_GMM)
    ...
    while True:
        try:
            while wait_queue.qsize() != 0:
                ...
                FLAGS.category_num = queue_data[5]
                FLAGS.category_name = select_category(FLAGS.category_num)
